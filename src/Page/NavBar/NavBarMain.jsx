                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex">
                    <div className="bg-white h-full shadow-xl p-4 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-7xl transform transition-transform duration-300 translate-x-0">
                        ...
                        <ul className="flex flex-col lg:hidden">
                            ...
                            <li><NavLink to="/service" className="block py-2 text-base text-black">SERVICE</NavLink></li>
                            <li><NavLink to="/blog" className="block py-2 text-base text-black">BLOG</NavLink></li>
