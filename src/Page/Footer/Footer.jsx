...
import { FaClinicMedical, FaPhone, FaVoicemail } from "react-icons/fa";


const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content flex flex-col lg:flex-row justify-between">
                <div>
                    ...
                    <div>
                        ...
                        <hr />
                        <p className="flex flex-col lg:flex-row items-center text-base gap-2 mb-4">
                            <CiLocationOn className="text-base"></CiLocationOn>
                            69 Halsey St, New York, Ny 10002, United States.

                        </p>
                        <hr />
                        <p className="flex items-center gap-2 mb-4">
                            <FaVoicemail className="text-base "></FaVoicemail>
                            hello@yourdomain.com
                        </p>
                        <hr />
                        <p className="flex items-center gap-2">
                            <FaPhone className="text-base"></FaPhone>
                            +123 456 7890
                        </p>
            ...
            <footer className="footer items-center justify-center gap-36 p-4 bg-neutral text-neutral-content">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Copyright © 2024 HOPE - All right reserved</p>
                </aside>
